...
//    }
    ...
    TGraph* g4 = (TGraph*)f->Get("/Analysis/QDC/gRelCut");
...
void DrawDtInt(TFile* f, string FC, string Setup)
{
    ...
    if (strcmp(Setup.c_str(), "SF") != 0)
    {
        ...
        TCanvas* c4 = new TCanvas(name, name, 200, 10, 700, 500);
...
void DrawSFRate(TFile* fNIF, TFile* fSB, TFile* fSF, TFile* fCom)
{
    ...
    TLegend* l1 = new TLegend(0.6, 0.2, 0.85, 0.40, "Measurement");
    ...
    TGraphErrors* g4 = (TGraphErrors*)fCom->Get("/Analysis/SF/SF_Rate");
    BiasX(g4, 0.15);
    g4->SetLineWidth(lw);
    g4->SetLineColor(kBlack);
    mg1->Add(g4);
    l1->AddEntry(g4, "Combined", "lp");

    mg1->Draw("AP");
    mg1->GetYaxis()->SetRangeUser(0, 4.5);
    l1->Draw();
    c7->Modified();
    c7->Update();
}
void DrawNPu(TFile* f)
{
    ...
    gPad->SetTicks(1, 1);
    TMultiGraph* mg2 = new TMultiGraph();
    mg2->SetTitle("Effective number of Pu-242 atoms; Deposit; N");
    TLegend* l2 = new TLegend(0.6, 0.2, 0.85, 0.40, "Evaluated");

    TGraphErrors* g5 = (TGraphErrors*)f->Get("/Analysis/SF/NPuEff");
    ...
    gPad->SetTicks(1, 1);
    TMultiGraph* mg3 = new TMultiGraph();
    mg3->SetTitle("Number of Pu-242 atoms using internal efficiency; Deposit; N");

    TGraphErrors* g7 = (TGraphErrors*)f->Get("/Analysis/SF/NPu");
    g7->SetLineWidth(lw);
    mg3->Add(g7);
...
void DrawQDCmin(TFile* fNIF, TFile* fSB, TFile* fSF, TFile* fCom)
{
    /// QDC extrema fit results
    TCanvas* c8 = new TCanvas("PuFC_QDCfit", "Common fit results for PuFC", 200, 10, 700, 500);
    gPad->SetTicks(1, 1);
    TMultiGraph* mg2 = new TMultiGraph();
    mg2->SetTitle("Common fit results for PuFC; Deposit; QDC channel (low gain)");
    TLegend* l2 = new TLegend(0.6, 0.2, 0.85, 0.40, "Setup");
    ...
    TGraphErrors* g5 = (TGraphErrors*)fCom->Get("/Analysis/QDC/gCut");
    BiasX(g5, +0.1);
    g5->SetLineWidth(lw);
...
void DrawIntEff(TFile* fNIF, TFile* fSB, TFile* fSF, TFile* fCom)
{
    ...
    TLegend* l1 = new TLegend(0.6, 0.2, 0.85, 0.40, "Setup");
...
void DrawEval(TFile* f)
{
    ...
    TGraphErrors* g1 = (TGraphErrors*)f->Get("/Analysis/Evaluation/XS_SF");
    g1->SetLineWidth(lw);
    ...
    TLegend* l3 = new TLegend(0.6, 0.2, 0.85, 0.40, "Fission fragments");

    TGraphErrors* g7 = (TGraphErrors*)f->Get("/Analysis/Evaluation/eNIF");
    BiasX(g7, -0.1);
    ...
    TGraphErrors* g8 = (TGraphErrors*)f->Get("/Analysis/Evaluation/eSF");
    g8->SetLineColor(kGreen);
    g8->SetLineWidth(lw);
    mg3->Add(g8);
    l3->AddEntry(g8, "Spontaneaus (average)");

    TGraphErrors* g9 = (TGraphErrors*)f->Get("/Analysis/Evaluation/eRel");
    BiasX(g9, +0.1);
